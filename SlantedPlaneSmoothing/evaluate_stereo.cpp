...
bool eval () {
  ...
  string gt_noc_dir      = "data_stereo_flow/training/disp_noc";
  string gt_occ_dir      = "data_stereo_flow/training/disp_occ";
  string gt_refl_noc_dir = "data_stereo_flow/training/disp_refl_noc";
  string gt_refl_occ_dir = "data_stereo_flow/training/disp_refl_occ";
  string gt_img_dir      = "data_stereo_flow/training/image_0";
  ...
  for (int32_t i=0; i<194; i++) {
    ...
    try {
      ...
      if (!imageFormat(image_file,png::color_type_gray,16,D_gt_noc.width(),D_gt_noc.height())) {
        ...
        printf("ERROR: Input must be png, 1 channel, 16 bit, %d x %d px",
